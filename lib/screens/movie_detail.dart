                        ...
                        Align(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text("${widget.data.publishedYear} | ${Utils.integerMinToString(widget.data.durationMin)} | ${widget.data.type}",
                        ...
                        SafeArea(
                          child: Align(
                            ...
                            child: IconButton(
                                ...
                                icon: Icon(
                                  provider.isWishMovies(widget.data) ? Icons.favorite : Icons.favorite_border_outlined,
                                  color: Colors.white,
                                  size: 30,
                                )),
                          ),
